export const projects = [
  {
    ...
    features: [
      ...
      "Resource access hub for D.C. residents",
      "Trust-building design language consistent with SAGE brand",
    ],
    color: "#c8ff47",
    prototype: null,
  },
  {
    ...
    features: [
      "Transparent loan terms with plain-language explanations",
      "Budgeting tools tailored to low-income households",
      "Educational modules redirecting users from predatory lending",
      "Community-first onboarding that builds trust progressively",
    ],
    color: "#7df9d4",
    prototype: "https://www.figma.com",
    protocolLabel: "View Prototype",
  },
  {
    slug: "intuition",
    title: "InTuition",
    ...
    features: [
      "Smart matching system filtering scholarships by student profile",
      "Unified application allowing students to apply to multiple opportunities at once",
      "Deadline tracking and reminder system",
      "Guidance resources for first-generation college students",
    ],
    color: "#9b8dff",
    prototype: "https://www.figma.com",
    protocolLabel: "View Prototype",
  },
  {
    ...
    features: [
      "Real-time shuttle location tracking across all GWU campuses",
      "Estimated arrival times with live crowd-level data",
      "Expanded stop coverage beyond existing shuttle routes",
      "Dining hall integration for combined commute planning",
    ],
    color: "#ff8c5a",
    prototype: "https://www.figma.com",
    protocolLabel: "View Prototype",
  },
  {
    ...
    features: [
      ...
      "Color-focused studies exploring mood and narrative",
      "Product and portrait sessions",
    ],
    color: "#f7c59f",
    instagram: "https://instagram.com/joshuba.archive",
  },
];
...
export const experience = [
  ...
  },
  {
    ...
    role: "Web Designer",
    org: "Mom n Tot Spot",
    detail: "Designed and built web presence for a D.C. family brand",
  },
  {
    year: "2023",
    role: "Document Designer",
    org: "Joy Riot Advertisement Agency",
    detail: "Created print and digital assets for agency clients",
  },
  {
    year: "2020",
    role: "Design & Coding Intern",
    org: "Apple Coding Camp",
    detail: "Python, design prototyping, and product thinking",
  },
];
