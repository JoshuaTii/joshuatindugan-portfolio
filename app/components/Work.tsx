    ...
    >
      ...
      <div className="p-7">
        <div className="flex items-start justify-between mb-3">
          <div>
            <p className="text-xs tracking-widest uppercase mb-1.5" style={{ color: project.color }}>
              {project.category}
            </p>
        ...
        <p className="text-white/40 text-sm mb-6 line-clamp-3" style={{ lineHeight: 1.75 }}>
          {project.description}
        </p>
        ...
        <div className="mt-6 flex items-center gap-1.5 text-xs tracking-wider uppercase" style={{ color: project.color }}>
          View Project
...
export function Work() {
  ...
  return (
    <section id="work" className="relative z-10 py-32 md:py-40 bg-[#090909]/60">
      <div className="section-container">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-5">
            ...
            <p className="text-white/35 text-sm max-w-xs" style={{ lineHeight: 1.8 }}>
