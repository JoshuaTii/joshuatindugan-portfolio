  ...
  return (
    ...
    >
      <svg width="71" height="26" viewBox="0 0 71 26" fill="none" xmlns="http://www.w3.org/2000/svg">
        {/* Active-half fill - cyan in dark mode, teal in light mode */}
...
/* -- Sketch utility button - secondary pill for Clear / Undo / Redo ---------
   Matches SketchToggle height (26px), radius (13px), and border system.
   Disabled state drops to 30% opacity and removes pointer events.
-------------------------------------------------------------------------- */
...
/* -- Sketch toggle - pill that matches ThemeToggle height/border system -----
   Active:   green-filled pill, dark icon/label
   Inactive: outlined pill, green icon/label
   Tooltip:  appears below on hover/focus
-------------------------------------------------------------------------- */
...
/* -- Inline SVG icons for sketch utility buttons -------------------------- */
const ClearIcon = () => (
  <svg width="11" height="11" viewBox="0 0 16 16" fill="none" aria-hidden="true">
  ...
  return (
    <>
      ...
      >
        ...
        {/* -- Row 2: Sketch controls · Theme toggle (desktop only, right-aligned) */}
