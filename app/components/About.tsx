...
export function About() {
  ...
  return (
    <section id="about" className="relative z-10 py-32 md:py-40 bg-[#090909]/60">
      ...
      <div ref={ref} className="section-container grid md:grid-cols-2 gap-16 lg:gap-28 items-center">
        ...
        >
          ...
          <p className="text-white/50 mb-5 max-w-md" style={{ lineHeight: 1.85 }}>
          ...
          <p className="text-white/50 mb-12 max-w-md" style={{ lineHeight: 1.85 }}>
