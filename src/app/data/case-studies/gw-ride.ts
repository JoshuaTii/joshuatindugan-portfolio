      ...
      blocks: [
        ...
        },
        {
          ...
          images: [
            ...
            { src: "/gwride/lofi-sketch-3.png", alt: "Lo-fi explore, suggested nearby areas" },
            { src: "/gwride/lofi-sketch-4.png", alt: "Lo-fi shuttle bus info, live map and bus list" },
            { src: "/gwride/lofi-sketch-5.png", alt: "Lo-fi commute info, stop sequence" },
            { src: "/gwride/lofi-sketch-6.png", alt: "Lo-fi map view, explore places" },
            { src: "/gwride/lofi-sketch-7.png", alt: "Lo-fi full map view with campus landmarks" },
            { src: "/gwride/lofi-sketch-8.png", alt: "Lo-fi discovery, place detail" },
          ],
        },
        {
          type: "text",
        ...
        },
        {
          ...
          layout: "grid-4",
          images: [
            { src: "/gwride/proto-init-a.png", alt: "Initial prototype screen 1" },
            { src: "/gwride/proto-init-b.png", alt: "Initial prototype screen 2" },
            { src: "/gwride/proto-init-c.png", alt: "Initial prototype screen 3" },
            { src: "/gwride/proto-init-d.png", alt: "Initial prototype screen 4" },
            { src: "/gwride/proto-init-e.png", alt: "Initial prototype screen 5" },
            { src: "/gwride/proto-init-f.png", alt: "Initial prototype screen 6" },
            { src: "/gwride/proto-init-g.png", alt: "Initial prototype screen 7" },
          ],
        },
        {
          type: "text",
        ...
        },
        {
          ...
          layout: "grid-4",
          images: [
            { src: "/gwride/hifi-final-1.png", alt: "Prototype iteration screen 1" },
            { src: "/gwride/hifi-final-2.png", alt: "Prototype iteration screen 2" },
            { src: "/gwride/hifi-final-3.png", alt: "Prototype iteration screen 3" },
            { src: "/gwride/hifi-final-4.png", alt: "Prototype iteration screen 4" },
            { src: "/gwride/hifi-final-5.png", alt: "Prototype iteration screen 5" },
            { src: "/gwride/hifi-final-6.png", alt: "Prototype iteration screen 6" },
            { src: "/gwride/hifi-final-7.png", alt: "Prototype iteration screen 7" },
          ],
        },
        {
          type: "callout",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          layout: "grid-4",
          images: [
            { src: "/gwride/final-screens-1.png", alt: "GW Ride splash screen with logo" },
            { src: "/gwride/final-screens-2.png", alt: "Sign-in screen with GW email and password fields" },
            { src: "/gwride/final-screens-3.png", alt: "Email verification prompt after sign-in" },
            { src: "/gwride/final-screens-4.png", alt: "Email verified confirmation screen" },
            { src: "/gwride/final-screens-5.png", alt: "Location permission prompt for nearby stops and live ETAs" },
            { src: "/gwride/final-screens-6.png", alt: "Campus selection screen, Foggy Bottom or Mount Vernon" },
            { src: "/gwride/final-screens-7.png", alt: "Home screen with destination search and recent places" },
            { src: "/gwride/final-screens-8.png", alt: "Mount Vernon route screen with live shuttle arrival times" },
            { src: "/gwride/final-screens-9.png", alt: "Route detail with map, ETA, and stop information" },
            { src: "/gwride/final-screens-10.png", alt: "Route detail screen with arrival notification option" },
            { src: "/gwride/final-screens-11.png", alt: "Explore tab with nearby places to discover" },
            { src: "/gwride/final-screens-12.png", alt: "Explore place detail, Georgetown Downtown" },
          ],
          caption:
